$(document).ready(function () {
  ...
  $.fn.startOver = function () {
    ...
    $("#conversation").empty();
    const text =
      "Welcome! I'm DoctorSina. What symptoms are you currently experiencing? When you've entered all of your symptoms, please write '<b>Done</b>'. Make sure you enter as much symptoms as possible so the prediction can be as correct as possible.";
    $("#conversation").append(
